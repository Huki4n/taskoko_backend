...
func (e ProjectEdges) ColumnsOrErr() ([]*ProjectColumn, error) {
	if e.loadedTypes[0] {
...
// QueryColumns queries the "columns" edge of the Project entity.
func (pr *Project) QueryColumns() *ProjectColumnQuery {
	return NewProjectClient(pr.config).QueryColumns(pr)
}
