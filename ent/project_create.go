...
func (pc *ProjectCreate) AddColumnIDs(ids ...int) *ProjectCreate {
	pc.mutation.AddColumnIDs(ids...)
	return pc
}

// AddColumns adds the "columns" edges to the ProjectColumn entity.
func (pc *ProjectCreate) AddColumns(p ...*ProjectColumn) *ProjectCreate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return pc.AddColumnIDs(ids...)
}
...
func (pc *ProjectCreate) createSpec() (*Project, *sqlgraph.CreateSpec) {
	...
	if nodes := pc.mutation.ColumnsIDs(); len(nodes) > 0 {
